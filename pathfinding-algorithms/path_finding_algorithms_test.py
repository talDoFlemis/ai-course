...
import pytest
from path_finding_algorithms import (
    GBFS,
    AStar,
    Dijsktra,
    Graph,
    Node,
    greedy_beverage_machine,
)
...
def test_astar(source: Node, destination: Node, expected_path: List[Node]):
    # Arrange
    g = Graph()
    ...
    # Act
    path = a_star.shortest_path(source, destination)
